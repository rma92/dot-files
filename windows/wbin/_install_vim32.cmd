...
cd %~dp0
set wbin_dir=%~dp0
curl %CURL_PROXY_OPTS% -L "https://github.com/vim/vim-win32-installer/releases/download/v9.1.0/gvim_9.1.0_x86_signed.zip" --output gvim_9.1.0_x86_signed.zip
REM powershell -command "Expand-Archive -Force gvim_9.1.0_x64_signed.zip gvim91p"
expand unzip.ex_ unzip.exe
unzip -qq -o gvim_9.1.0_x86_signed.zip -d gvim91p
